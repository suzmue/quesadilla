...
int main(int argc, char* argv[]) {
  ...
  memcpy(A_copy, A, sizeof(struct coo_t)*size);
		...
		for(int i = 0; i < 100; i ++){
			...
			for(int i = 0; i < size; i ++) {
				if(A[i].idx0 != A_copy[i].idx0){
					cout << "Error permuting array: index incorrect: (0, 1, 2): [(2, []), (1, []), (0, [])]" << endl;
					exit(3);
				}
				...
				if(A[i].val != A_copy[i].val){
					cout << "Error permuting array: value incorrect: (0, 1, 2): [(2, []), (1, []), (0, [])]" << endl;
					exit(3);
				}
			}
		}
		...
		for(int i = 0; i < 100; i ++){
			...
			for(int i = 0; i < size; i ++) {
				if(A[i].idx0 != A_copy[i].idx0){
					cout << "Error permuting array: index incorrect: (0, 2, 1): [(1, []), (2, []), (0, [])]" << endl;
					exit(3);
				}
				if(A[i].idx1 != A_copy[i].idx1){
					cout << "Error permuting array: index incorrect: (0, 2, 1): [(1, []), (2, []), (0, [])]" << endl;
				...
				if(A[i].val != A_copy[i].val){
					cout << "Error permuting array: value incorrect: (0, 2, 1): [(1, []), (2, []), (0, [])]" << endl;
					exit(3);
				}
			}
		}
		...
		for(int i = 0; i < 100; i ++){
			...
			for(int i = 0; i < size; i ++) {
				if(A[i].idx0 != A_copy[i].idx0){
					cout << "Error permuting array: index incorrect: (1, 0, 2): [(2, []), (0, []), (1, [])]" << endl;
					exit(3);
				}
				if(A[i].idx1 != A_copy[i].idx1){
					cout << "Error permuting array: index incorrect: (1, 0, 2): [(2, []), (0, []), (1, [])]" << endl;
				...
				if(A[i].val != A_copy[i].val){
					cout << "Error permuting array: value incorrect: (1, 0, 2): [(2, []), (0, []), (1, [])]" << endl;
					exit(3);
				}
			}
		}
		...
		for(int i = 0; i < 100; i ++){
			...
			for(int i = 0; i < size; i ++) {
				if(A[i].idx0 != A_copy[i].idx0){
					cout << "Error permuting array: index incorrect: (1, 2, 0): [(0, []), (2, []), (1, [])]" << endl;
					exit(3);
				}
				if(A[i].idx1 != A_copy[i].idx1){
					cout << "Error permuting array: index incorrect: (1, 2, 0): [(0, []), (2, []), (1, [])]" << endl;
				...
				if(A[i].val != A_copy[i].val){
					cout << "Error permuting array: value incorrect: (1, 2, 0): [(0, []), (2, []), (1, [])]" << endl;
					exit(3);
				}
			}
		}
		...
		for(int i = 0; i < 100; i ++){
			...
			for(int i = 0; i < size; i ++) {
				if(A[i].idx0 != A_copy[i].idx0){
					cout << "Error permuting array: index incorrect: (2, 0, 1): [(1, []), (0, []), (2, [])]" << endl;
					exit(3);
				}
				if(A[i].idx1 != A_copy[i].idx1){
					cout << "Error permuting array: index incorrect: (2, 0, 1): [(1, []), (0, []), (2, [])]" << endl;
				...
				if(A[i].val != A_copy[i].val){
					cout << "Error permuting array: value incorrect: (2, 0, 1): [(1, []), (0, []), (2, [])]" << endl;
					exit(3);
				}
			}
		}
		...
		for(int i = 0; i < 100; i ++){
			...
			for(int i = 0; i < size; i ++) {
				if(A[i].idx0 != A_copy[i].idx0){
					cout << "Error permuting array: index incorrect: (2, 1, 0): [(0, []), (1, []), (2, [])]" << endl;
					exit(3);
				}
				if(A[i].idx1 != A_copy[i].idx1){
					cout << "Error permuting array: index incorrect: (2, 1, 0): [(0, []), (1, []), (2, [])]" << endl;
				...
				if(A[i].val != A_copy[i].val){
					cout << "Error permuting array: value incorrect: (2, 1, 0): [(0, []), (1, []), (2, [])]" << endl;
					exit(3);
				}
			}
		}
