...
int transpose_coo_0123_k0(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	taco::util::Timer timer_0_cmp_0123;
	timer_0_cmp_0123.start();
	// Use qsort to sort the subtrees
	qsort(C_coords, c_size, sizeof(struct coo_t), cmp_0123);
	timer_0_cmp_0123.stop();
	taco::util::TimeResults res_0_cmp_0123 = timer_0_cmp_0123.getResult();
	cout << " | 0_cmp_0123 ";
	cout << " | "<< res_0_cmp_0123 ;
	return 0;
}
...
int transpose_coo_0123_k1(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	// Sort the coordinates to be in (0, 1, 2, 3)
	taco::util::Timer timer_1_cmp_123;
	timer_1_cmp_123.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	...
	timer_1_cmp_123.stop();
	taco::util::TimeResults res_1_cmp_123 = timer_1_cmp_123.getResult();
	cout << " | 1_cmp_123 ";
	cout << " | "<< res_1_cmp_123 ;
	return 0;
}
...
int transpose_coo_0123_k2(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	// Sort the coordinates to be in (0, 1, 2, 3)
	taco::util::Timer timer_2_cmp_23;
	timer_2_cmp_23.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	for(int i = 1; i < c_size; i ++)
	{
	...
	timer_2_cmp_23.stop();
	taco::util::TimeResults res_2_cmp_23 = timer_2_cmp_23.getResult();
	cout << " | 2_cmp_23 ";
	cout << " | "<< res_2_cmp_23 ;
	return 0;
}
...
int transpose_coo_0123_k3(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	timer_3_cmp_3.stop();
	taco::util::TimeResults res_3_cmp_3 = timer_3_cmp_3.getResult();
	cout << " | 3_cmp_3 ";
	cout << " | "<< res_3_cmp_3 ;
	return 0;
}
...
int transpose_coo_0132_k0(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	taco::util::Timer timer_0_cmp_0132;
	timer_0_cmp_0132.start();
	// Use qsort to sort the subtrees
	qsort(C_coords, c_size, sizeof(struct coo_t), cmp_0132);
	timer_0_cmp_0132.stop();
	taco::util::TimeResults res_0_cmp_0132 = timer_0_cmp_0132.getResult();
	cout << " | 0_cmp_0132 ";
	cout << " | "<< res_0_cmp_0132 ;
	return 0;
}
...
int transpose_coo_0132_k1(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	// Sort the coordinates to be in (0, 1, 3, 2)
	taco::util::Timer timer_1_cmp_132;
	timer_1_cmp_132.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	for(int i = 1; i < c_size; i ++)
	{
	...
	timer_1_cmp_132.stop();
	taco::util::TimeResults res_1_cmp_132 = timer_1_cmp_132.getResult();
	cout << " | 1_cmp_132 ";
	cout << " | "<< res_1_cmp_132 ;
	return 0;
}
...
int transpose_coo_0132_k2(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	// Sort the coordinates to be in (0, 1, 3, 2)
	taco::util::Timer timer_2_cmp_32;
	timer_2_cmp_32.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	for(int i = 1; i < c_size; i ++)
	{
	...
	timer_2_cmp_32.stop();
	taco::util::TimeResults res_2_cmp_32 = timer_2_cmp_32.getResult();
	cout << " | 2_cmp_32 ";
	cout << " | "<< res_2_cmp_32 ;
	return 0;
}
...
int transpose_coo_0132_k3(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	timer_3_cmp_2.stop();
	taco::util::TimeResults res_3_cmp_2 = timer_3_cmp_2.getResult();
	cout << " | 3_cmp_2 ";
	cout << " | "<< res_3_cmp_2 ;
...
int transpose_coo_0213_k0(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	taco::util::Timer timer_0_cmp_0213;
	timer_0_cmp_0213.start();
	// Use qsort to sort the subtrees
	qsort(C_coords, c_size, sizeof(struct coo_t), cmp_0213);
	timer_0_cmp_0213.stop();
	taco::util::TimeResults res_0_cmp_0213 = timer_0_cmp_0213.getResult();
	cout << " | 0_cmp_0213 ";
	cout << " | "<< res_0_cmp_0213 ;
	return 0;
}
...
int transpose_coo_0213_k1(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	// Sort the coordinates to be in (0, 2, 1, 3)
	taco::util::Timer timer_1_cmp_213;
	timer_1_cmp_213.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	for(int i = 1; i < c_size; i ++)
	{
	...
	timer_1_cmp_213.stop();
	taco::util::TimeResults res_1_cmp_213 = timer_1_cmp_213.getResult();
	cout << " | 1_cmp_213 ";
	cout << " | "<< res_1_cmp_213 ;
	return 0;
}
...
int transpose_coo_0213_k2(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	cout << " , (2, [0]) ";
	cout << " , "<< res_20 ;
	taco::util::Timer timer_2_cmp_13;
	timer_2_cmp_13.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	for(int i = 1; i < c_size; i ++)
	{
	...
	timer_2_cmp_13.stop();
	taco::util::TimeResults res_2_cmp_13 = timer_2_cmp_13.getResult();
	cout << " | 2_cmp_13 ";
	cout << " | "<< res_2_cmp_13 ;
	// Free the scratch space.
	free(C_coords_scratch);
...
int transpose_coo_0231_k0(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	taco::util::Timer timer_0_cmp_0231;
	timer_0_cmp_0231.start();
	// Use qsort to sort the subtrees
	qsort(C_coords, c_size, sizeof(struct coo_t), cmp_0231);
	timer_0_cmp_0231.stop();
	taco::util::TimeResults res_0_cmp_0231 = timer_0_cmp_0231.getResult();
	cout << " | 0_cmp_0231 ";
	cout << " | "<< res_0_cmp_0231 ;
	return 0;
}
...
int transpose_coo_0231_k1(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	// Sort the coordinates to be in (0, 2, 3, 1)
	taco::util::Timer timer_1_cmp_231;
	timer_1_cmp_231.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	for(int i = 1; i < c_size; i ++)
	{
	...
	timer_1_cmp_231.stop();
	taco::util::TimeResults res_1_cmp_231 = timer_1_cmp_231.getResult();
	cout << " | 1_cmp_231 ";
	cout << " | "<< res_1_cmp_231 ;
	return 0;
}
...
int transpose_coo_0231_k2(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	cout << " , (2, [0]) ";
	cout << " , "<< res_20 ;
	taco::util::Timer timer_2_cmp_31;
	timer_2_cmp_31.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	for(int i = 1; i < c_size; i ++)
	{
	...
	timer_2_cmp_31.stop();
	taco::util::TimeResults res_2_cmp_31 = timer_2_cmp_31.getResult();
	cout << " | 2_cmp_31 ";
	cout << " | "<< res_2_cmp_31 ;
	// Free the scratch space.
	free(C_coords_scratch);
...
int transpose_coo_0231_k3(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	timer_3_cmp_1.stop();
	taco::util::TimeResults res_3_cmp_1 = timer_3_cmp_1.getResult();
	cout << " | 3_cmp_1 ";
	cout << " | "<< res_3_cmp_1 ;
	// Free the scratch space.
	free(C_coords_scratch);
...
int transpose_coo_0312_k0(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	taco::util::Timer timer_0_cmp_0312;
	timer_0_cmp_0312.start();
	// Use qsort to sort the subtrees
	qsort(C_coords, c_size, sizeof(struct coo_t), cmp_0312);
	timer_0_cmp_0312.stop();
	taco::util::TimeResults res_0_cmp_0312 = timer_0_cmp_0312.getResult();
	cout << " | 0_cmp_0312 ";
	cout << " | "<< res_0_cmp_0312 ;
	return 0;
}
...
int transpose_coo_0312_k1(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	// Sort the coordinates to be in (0, 3, 1, 2)
	taco::util::Timer timer_1_cmp_312;
	timer_1_cmp_312.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	for(int i = 1; i < c_size; i ++)
	{
	...
	timer_1_cmp_312.stop();
	taco::util::TimeResults res_1_cmp_312 = timer_1_cmp_312.getResult();
	cout << " | 1_cmp_312 ";
	cout << " | "<< res_1_cmp_312 ;
	return 0;
}
...
int transpose_coo_0312_k2(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	cout << " , (3, [0]) ";
	cout << " , "<< res_30 ;
	taco::util::Timer timer_2_cmp_12;
	timer_2_cmp_12.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	for(int i = 1; i < c_size; i ++)
	{
	...
	timer_2_cmp_12.stop();
	taco::util::TimeResults res_2_cmp_12 = timer_2_cmp_12.getResult();
	cout << " | 2_cmp_12 ";
	cout << " | "<< res_2_cmp_12 ;
	// Free the scratch space.
	free(C_coords_scratch);
...
int transpose_coo_0321_k0(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	taco::util::Timer timer_0_cmp_0321;
	timer_0_cmp_0321.start();
	// Use qsort to sort the subtrees
	qsort(C_coords, c_size, sizeof(struct coo_t), cmp_0321);
	timer_0_cmp_0321.stop();
	taco::util::TimeResults res_0_cmp_0321 = timer_0_cmp_0321.getResult();
	cout << " | 0_cmp_0321 ";
	cout << " | "<< res_0_cmp_0321 ;
	return 0;
}
...
int transpose_coo_0321_k1(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	// Sort the coordinates to be in (0, 3, 2, 1)
	taco::util::Timer timer_1_cmp_321;
	timer_1_cmp_321.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	for(int i = 1; i < c_size; i ++)
	{
	...
	timer_1_cmp_321.stop();
	taco::util::TimeResults res_1_cmp_321 = timer_1_cmp_321.getResult();
	cout << " | 1_cmp_321 ";
	cout << " | "<< res_1_cmp_321 ;
	return 0;
}
...
int transpose_coo_0321_k2(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	cout << " , (3, [0]) ";
	cout << " , "<< res_30 ;
	taco::util::Timer timer_2_cmp_21;
	timer_2_cmp_21.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	for(int i = 1; i < c_size; i ++)
	{
	...
	timer_2_cmp_21.stop();
	taco::util::TimeResults res_2_cmp_21 = timer_2_cmp_21.getResult();
	cout << " | 2_cmp_21 ";
	cout << " | "<< res_2_cmp_21 ;
	// Free the scratch space.
	free(C_coords_scratch);
...
int transpose_coo_1023_k0(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	taco::util::Timer timer_0_cmp_1023;
	timer_0_cmp_1023.start();
	// Use qsort to sort the subtrees
	qsort(C_coords, c_size, sizeof(struct coo_t), cmp_1023);
	timer_0_cmp_1023.stop();
	taco::util::TimeResults res_0_cmp_1023 = timer_0_cmp_1023.getResult();
	cout << " | 0_cmp_1023 ";
	cout << " | "<< res_0_cmp_1023 ;
	return 0;
}
...
int transpose_coo_1023_k1(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	cout << " , (1, []) ";
	cout << " , "<< res_1 ;
	taco::util::Timer timer_1_cmp_023;
	timer_1_cmp_023.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	for(int i = 1; i < c_size; i ++)
	{
	...
	timer_1_cmp_023.stop();
	taco::util::TimeResults res_1_cmp_023 = timer_1_cmp_023.getResult();
	cout << " | 1_cmp_023 ";
	cout << " | "<< res_1_cmp_023 ;
	// Free the scratch space.
	free(C_coords_scratch);
...
int transpose_coo_1032_k0(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	taco::util::Timer timer_0_cmp_1032;
	timer_0_cmp_1032.start();
	// Use qsort to sort the subtrees
	qsort(C_coords, c_size, sizeof(struct coo_t), cmp_1032);
	timer_0_cmp_1032.stop();
	taco::util::TimeResults res_0_cmp_1032 = timer_0_cmp_1032.getResult();
	cout << " | 0_cmp_1032 ";
	cout << " | "<< res_0_cmp_1032 ;
	return 0;
}
...
int transpose_coo_1032_k1(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	cout << " , (1, []) ";
	cout << " , "<< res_1 ;
	taco::util::Timer timer_1_cmp_032;
	timer_1_cmp_032.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	for(int i = 1; i < c_size; i ++)
	{
	...
	timer_1_cmp_032.stop();
	taco::util::TimeResults res_1_cmp_032 = timer_1_cmp_032.getResult();
	cout << " | 1_cmp_032 ";
	cout << " | "<< res_1_cmp_032 ;
	// Free the scratch space.
	free(C_coords_scratch);
...
int transpose_coo_1203_k0(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	taco::util::Timer timer_0_cmp_1203;
	timer_0_cmp_1203.start();
	// Use qsort to sort the subtrees
	qsort(C_coords, c_size, sizeof(struct coo_t), cmp_1203);
	timer_0_cmp_1203.stop();
	taco::util::TimeResults res_0_cmp_1203 = timer_0_cmp_1203.getResult();
	cout << " | 0_cmp_1203 ";
	cout << " | "<< res_0_cmp_1203 ;
	return 0;
}
...
int transpose_coo_1203_k1(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	cout << " , (1, []) ";
	cout << " , "<< res_1 ;
	taco::util::Timer timer_1_cmp_203;
	timer_1_cmp_203.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	for(int i = 1; i < c_size; i ++)
	{
	...
	timer_1_cmp_203.stop();
	taco::util::TimeResults res_1_cmp_203 = timer_1_cmp_203.getResult();
	cout << " | 1_cmp_203 ";
	cout << " | "<< res_1_cmp_203 ;
	// Free the scratch space.
	free(C_coords_scratch);
...
int transpose_coo_1203_k2(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	cout << " , (1, []) ";
	cout << " , "<< res_1 ;
	taco::util::Timer timer_2_cmp_03;
	timer_2_cmp_03.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	for(int i = 1; i < c_size; i ++)
	{
	...
	timer_2_cmp_03.stop();
	taco::util::TimeResults res_2_cmp_03 = timer_2_cmp_03.getResult();
	cout << " | 2_cmp_03 ";
	cout << " | "<< res_2_cmp_03 ;
	// Free the scratch space.
	free(C_coords_scratch);
...
int transpose_coo_1230_k0(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	taco::util::Timer timer_0_cmp_1230;
	timer_0_cmp_1230.start();
	// Use qsort to sort the subtrees
	qsort(C_coords, c_size, sizeof(struct coo_t), cmp_1230);
	timer_0_cmp_1230.stop();
	taco::util::TimeResults res_0_cmp_1230 = timer_0_cmp_1230.getResult();
	cout << " | 0_cmp_1230 ";
	cout << " | "<< res_0_cmp_1230 ;
	return 0;
}
...
int transpose_coo_1230_k1(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	cout << " , (1, []) ";
	cout << " , "<< res_1 ;
	taco::util::Timer timer_1_cmp_230;
	timer_1_cmp_230.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	for(int i = 1; i < c_size; i ++)
	{
	...
	timer_1_cmp_230.stop();
	taco::util::TimeResults res_1_cmp_230 = timer_1_cmp_230.getResult();
	cout << " | 1_cmp_230 ";
	cout << " | "<< res_1_cmp_230 ;
	// Free the scratch space.
	free(C_coords_scratch);
...
int transpose_coo_1230_k2(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	cout << " , (1, []) ";
	cout << " , "<< res_1 ;
	taco::util::Timer timer_2_cmp_30;
	timer_2_cmp_30.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	for(int i = 1; i < c_size; i ++)
	{
	...
	timer_2_cmp_30.stop();
	taco::util::TimeResults res_2_cmp_30 = timer_2_cmp_30.getResult();
	cout << " | 2_cmp_30 ";
	cout << " | "<< res_2_cmp_30 ;
	// Free the scratch space.
	free(C_coords_scratch);
...
int transpose_coo_1230_k3(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	timer_3_cmp_0.stop();
	taco::util::TimeResults res_3_cmp_0 = timer_3_cmp_0.getResult();
	cout << " | 3_cmp_0 ";
	cout << " | "<< res_3_cmp_0 ;
	// Free the scratch space.
	free(C_coords_scratch);
...
int transpose_coo_1302_k0(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	taco::util::Timer timer_0_cmp_1302;
	timer_0_cmp_1302.start();
	// Use qsort to sort the subtrees
	qsort(C_coords, c_size, sizeof(struct coo_t), cmp_1302);
	timer_0_cmp_1302.stop();
	taco::util::TimeResults res_0_cmp_1302 = timer_0_cmp_1302.getResult();
	cout << " | 0_cmp_1302 ";
	cout << " | "<< res_0_cmp_1302 ;
	return 0;
}
...
int transpose_coo_1302_k1(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	cout << " , (1, []) ";
	cout << " , "<< res_1 ;
	taco::util::Timer timer_1_cmp_302;
	timer_1_cmp_302.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	for(int i = 1; i < c_size; i ++)
	{
	...
	timer_1_cmp_302.stop();
	taco::util::TimeResults res_1_cmp_302 = timer_1_cmp_302.getResult();
	cout << " | 1_cmp_302 ";
	cout << " | "<< res_1_cmp_302 ;
	// Free the scratch space.
	free(C_coords_scratch);
...
int transpose_coo_1302_k2(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	cout << " , (1, []) ";
	cout << " , "<< res_1 ;
	taco::util::Timer timer_2_cmp_02;
	timer_2_cmp_02.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	for(int i = 1; i < c_size; i ++)
	{
	...
	timer_2_cmp_02.stop();
	taco::util::TimeResults res_2_cmp_02 = timer_2_cmp_02.getResult();
	cout << " | 2_cmp_02 ";
	cout << " | "<< res_2_cmp_02 ;
	// Free the scratch space.
	free(C_coords_scratch);
...
int transpose_coo_1320_k0(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	taco::util::Timer timer_0_cmp_1320;
	timer_0_cmp_1320.start();
	// Use qsort to sort the subtrees
	qsort(C_coords, c_size, sizeof(struct coo_t), cmp_1320);
	timer_0_cmp_1320.stop();
	taco::util::TimeResults res_0_cmp_1320 = timer_0_cmp_1320.getResult();
	cout << " | 0_cmp_1320 ";
	cout << " | "<< res_0_cmp_1320 ;
	return 0;
}
...
int transpose_coo_1320_k1(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	cout << " , (1, []) ";
	cout << " , "<< res_1 ;
	taco::util::Timer timer_1_cmp_320;
	timer_1_cmp_320.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	for(int i = 1; i < c_size; i ++)
	{
	...
	timer_1_cmp_320.stop();
	taco::util::TimeResults res_1_cmp_320 = timer_1_cmp_320.getResult();
	cout << " | 1_cmp_320 ";
	cout << " | "<< res_1_cmp_320 ;
	// Free the scratch space.
	free(C_coords_scratch);
...
int transpose_coo_1320_k2(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	cout << " , (1, []) ";
	cout << " , "<< res_1 ;
	taco::util::Timer timer_2_cmp_20;
	timer_2_cmp_20.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	for(int i = 1; i < c_size; i ++)
	{
	...
	timer_2_cmp_20.stop();
	taco::util::TimeResults res_2_cmp_20 = timer_2_cmp_20.getResult();
	cout << " | 2_cmp_20 ";
	cout << " | "<< res_2_cmp_20 ;
	// Free the scratch space.
	free(C_coords_scratch);
...
int transpose_coo_2013_k0(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	taco::util::Timer timer_0_cmp_2013;
	timer_0_cmp_2013.start();
	// Use qsort to sort the subtrees
	qsort(C_coords, c_size, sizeof(struct coo_t), cmp_2013);
	timer_0_cmp_2013.stop();
	taco::util::TimeResults res_0_cmp_2013 = timer_0_cmp_2013.getResult();
	cout << " | 0_cmp_2013 ";
	cout << " | "<< res_0_cmp_2013 ;
	return 0;
}
...
int transpose_coo_2013_k1(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	cout << " , (2, []) ";
	cout << " , "<< res_2 ;
	taco::util::Timer timer_1_cmp_013;
	timer_1_cmp_013.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	for(int i = 1; i < c_size; i ++)
	{
	...
	timer_1_cmp_013.stop();
	taco::util::TimeResults res_1_cmp_013 = timer_1_cmp_013.getResult();
	cout << " | 1_cmp_013 ";
	cout << " | "<< res_1_cmp_013 ;
	// Free the scratch space.
	free(C_coords_scratch);
...
int transpose_coo_2031_k0(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	taco::util::Timer timer_0_cmp_2031;
	timer_0_cmp_2031.start();
	// Use qsort to sort the subtrees
	qsort(C_coords, c_size, sizeof(struct coo_t), cmp_2031);
	timer_0_cmp_2031.stop();
	taco::util::TimeResults res_0_cmp_2031 = timer_0_cmp_2031.getResult();
	cout << " | 0_cmp_2031 ";
	cout << " | "<< res_0_cmp_2031 ;
	return 0;
}
...
int transpose_coo_2031_k1(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	cout << " , (2, []) ";
	cout << " , "<< res_2 ;
	taco::util::Timer timer_1_cmp_031;
	timer_1_cmp_031.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	for(int i = 1; i < c_size; i ++)
	{
	...
	timer_1_cmp_031.stop();
	taco::util::TimeResults res_1_cmp_031 = timer_1_cmp_031.getResult();
	cout << " | 1_cmp_031 ";
	cout << " | "<< res_1_cmp_031 ;
	// Free the scratch space.
	free(C_coords_scratch);
...
int transpose_coo_2103_k0(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	taco::util::Timer timer_0_cmp_2103;
	timer_0_cmp_2103.start();
	// Use qsort to sort the subtrees
	qsort(C_coords, c_size, sizeof(struct coo_t), cmp_2103);
	timer_0_cmp_2103.stop();
	taco::util::TimeResults res_0_cmp_2103 = timer_0_cmp_2103.getResult();
	cout << " | 0_cmp_2103 ";
	cout << " | "<< res_0_cmp_2103 ;
	return 0;
}
...
int transpose_coo_2103_k1(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	cout << " , (2, []) ";
	cout << " , "<< res_2 ;
	taco::util::Timer timer_1_cmp_103;
	timer_1_cmp_103.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	for(int i = 1; i < c_size; i ++)
	{
	...
	timer_1_cmp_103.stop();
	taco::util::TimeResults res_1_cmp_103 = timer_1_cmp_103.getResult();
	cout << " | 1_cmp_103 ";
	cout << " | "<< res_1_cmp_103 ;
	// Free the scratch space.
	free(C_coords_scratch);
...
int transpose_coo_2130_k0(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	taco::util::Timer timer_0_cmp_2130;
	timer_0_cmp_2130.start();
	// Use qsort to sort the subtrees
	qsort(C_coords, c_size, sizeof(struct coo_t), cmp_2130);
	timer_0_cmp_2130.stop();
	taco::util::TimeResults res_0_cmp_2130 = timer_0_cmp_2130.getResult();
	cout << " | 0_cmp_2130 ";
	cout << " | "<< res_0_cmp_2130 ;
	return 0;
}
...
int transpose_coo_2130_k1(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	cout << " , (2, []) ";
	cout << " , "<< res_2 ;
	taco::util::Timer timer_1_cmp_130;
	timer_1_cmp_130.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	for(int i = 1; i < c_size; i ++)
	{
	...
	timer_1_cmp_130.stop();
	taco::util::TimeResults res_1_cmp_130 = timer_1_cmp_130.getResult();
	cout << " | 1_cmp_130 ";
	cout << " | "<< res_1_cmp_130 ;
	// Free the scratch space.
	free(C_coords_scratch);
...
int transpose_coo_2301_k0(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	taco::util::Timer timer_0_cmp_2301;
	timer_0_cmp_2301.start();
	// Use qsort to sort the subtrees
	qsort(C_coords, c_size, sizeof(struct coo_t), cmp_2301);
	timer_0_cmp_2301.stop();
	taco::util::TimeResults res_0_cmp_2301 = timer_0_cmp_2301.getResult();
	cout << " | 0_cmp_2301 ";
	cout << " | "<< res_0_cmp_2301 ;
	return 0;
}
...
int transpose_coo_2301_k1(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	cout << " , (2, []) ";
	cout << " , "<< res_2 ;
	taco::util::Timer timer_1_cmp_301;
	timer_1_cmp_301.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	for(int i = 1; i < c_size; i ++)
	{
	...
	timer_1_cmp_301.stop();
	taco::util::TimeResults res_1_cmp_301 = timer_1_cmp_301.getResult();
	cout << " | 1_cmp_301 ";
	cout << " | "<< res_1_cmp_301 ;
	// Free the scratch space.
	free(C_coords_scratch);
...
int transpose_coo_2301_k2(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	cout << " , (2, []) ";
	cout << " , "<< res_2 ;
	taco::util::Timer timer_2_cmp_01;
	timer_2_cmp_01.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	for(int i = 1; i < c_size; i ++)
	{
	...
	timer_2_cmp_01.stop();
	taco::util::TimeResults res_2_cmp_01 = timer_2_cmp_01.getResult();
	cout << " | 2_cmp_01 ";
	cout << " | "<< res_2_cmp_01 ;
	// Free the scratch space.
	free(C_coords_scratch);
...
int transpose_coo_2310_k0(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	taco::util::Timer timer_0_cmp_2310;
	timer_0_cmp_2310.start();
	// Use qsort to sort the subtrees
	qsort(C_coords, c_size, sizeof(struct coo_t), cmp_2310);
	timer_0_cmp_2310.stop();
	taco::util::TimeResults res_0_cmp_2310 = timer_0_cmp_2310.getResult();
	cout << " | 0_cmp_2310 ";
	cout << " | "<< res_0_cmp_2310 ;
	return 0;
}
...
int transpose_coo_2310_k1(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	cout << " , (2, []) ";
	cout << " , "<< res_2 ;
	taco::util::Timer timer_1_cmp_310;
	timer_1_cmp_310.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	for(int i = 1; i < c_size; i ++)
	{
	...
	timer_1_cmp_310.stop();
	taco::util::TimeResults res_1_cmp_310 = timer_1_cmp_310.getResult();
	cout << " | 1_cmp_310 ";
	cout << " | "<< res_1_cmp_310 ;
	// Free the scratch space.
	free(C_coords_scratch);
...
int transpose_coo_2310_k2(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	cout << " , (2, []) ";
	cout << " , "<< res_2 ;
	taco::util::Timer timer_2_cmp_10;
	timer_2_cmp_10.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	for(int i = 1; i < c_size; i ++)
	{
	...
	timer_2_cmp_10.stop();
	taco::util::TimeResults res_2_cmp_10 = timer_2_cmp_10.getResult();
	cout << " | 2_cmp_10 ";
	cout << " | "<< res_2_cmp_10 ;
	// Free the scratch space.
	free(C_coords_scratch);
...
int transpose_coo_3012_k0(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	taco::util::Timer timer_0_cmp_3012;
	timer_0_cmp_3012.start();
	// Use qsort to sort the subtrees
	qsort(C_coords, c_size, sizeof(struct coo_t), cmp_3012);
	timer_0_cmp_3012.stop();
	taco::util::TimeResults res_0_cmp_3012 = timer_0_cmp_3012.getResult();
	cout << " | 0_cmp_3012 ";
	cout << " | "<< res_0_cmp_3012 ;
	return 0;
}
...
int transpose_coo_3012_k1(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	cout << " , (3, []) ";
	cout << " , "<< res_3 ;
	taco::util::Timer timer_1_cmp_012;
	timer_1_cmp_012.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	for(int i = 1; i < c_size; i ++)
	{
	...
	timer_1_cmp_012.stop();
	taco::util::TimeResults res_1_cmp_012 = timer_1_cmp_012.getResult();
	cout << " | 1_cmp_012 ";
	cout << " | "<< res_1_cmp_012 ;
	// Free the scratch space.
	free(C_coords_scratch);
...
int transpose_coo_3021_k0(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	taco::util::Timer timer_0_cmp_3021;
	timer_0_cmp_3021.start();
	// Use qsort to sort the subtrees
	qsort(C_coords, c_size, sizeof(struct coo_t), cmp_3021);
	timer_0_cmp_3021.stop();
	taco::util::TimeResults res_0_cmp_3021 = timer_0_cmp_3021.getResult();
	cout << " | 0_cmp_3021 ";
	cout << " | "<< res_0_cmp_3021 ;
	return 0;
}
...
int transpose_coo_3021_k1(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	cout << " , (3, []) ";
	cout << " , "<< res_3 ;
	taco::util::Timer timer_1_cmp_021;
	timer_1_cmp_021.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	for(int i = 1; i < c_size; i ++)
	{
	...
	timer_1_cmp_021.stop();
	taco::util::TimeResults res_1_cmp_021 = timer_1_cmp_021.getResult();
	cout << " | 1_cmp_021 ";
	cout << " | "<< res_1_cmp_021 ;
	// Free the scratch space.
	free(C_coords_scratch);
...
int transpose_coo_3102_k0(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	taco::util::Timer timer_0_cmp_3102;
	timer_0_cmp_3102.start();
	// Use qsort to sort the subtrees
	qsort(C_coords, c_size, sizeof(struct coo_t), cmp_3102);
	timer_0_cmp_3102.stop();
	taco::util::TimeResults res_0_cmp_3102 = timer_0_cmp_3102.getResult();
	cout << " | 0_cmp_3102 ";
	cout << " | "<< res_0_cmp_3102 ;
	return 0;
}
...
int transpose_coo_3102_k1(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	cout << " , (3, []) ";
	cout << " , "<< res_3 ;
	taco::util::Timer timer_1_cmp_102;
	timer_1_cmp_102.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	for(int i = 1; i < c_size; i ++)
	{
	...
	timer_1_cmp_102.stop();
	taco::util::TimeResults res_1_cmp_102 = timer_1_cmp_102.getResult();
	cout << " | 1_cmp_102 ";
	cout << " | "<< res_1_cmp_102 ;
	// Free the scratch space.
	free(C_coords_scratch);
...
int transpose_coo_3120_k0(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	taco::util::Timer timer_0_cmp_3120;
	timer_0_cmp_3120.start();
	// Use qsort to sort the subtrees
	qsort(C_coords, c_size, sizeof(struct coo_t), cmp_3120);
	timer_0_cmp_3120.stop();
	taco::util::TimeResults res_0_cmp_3120 = timer_0_cmp_3120.getResult();
	cout << " | 0_cmp_3120 ";
	cout << " | "<< res_0_cmp_3120 ;
	return 0;
}
...
int transpose_coo_3120_k1(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	cout << " , (3, []) ";
	cout << " , "<< res_3 ;
	taco::util::Timer timer_1_cmp_120;
	timer_1_cmp_120.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	for(int i = 1; i < c_size; i ++)
	{
	...
	timer_1_cmp_120.stop();
	taco::util::TimeResults res_1_cmp_120 = timer_1_cmp_120.getResult();
	cout << " | 1_cmp_120 ";
	cout << " | "<< res_1_cmp_120 ;
	// Free the scratch space.
	free(C_coords_scratch);
...
int transpose_coo_3201_k0(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	taco::util::Timer timer_0_cmp_3201;
	timer_0_cmp_3201.start();
	// Use qsort to sort the subtrees
	qsort(C_coords, c_size, sizeof(struct coo_t), cmp_3201);
	timer_0_cmp_3201.stop();
	taco::util::TimeResults res_0_cmp_3201 = timer_0_cmp_3201.getResult();
	cout << " | 0_cmp_3201 ";
	cout << " | "<< res_0_cmp_3201 ;
	return 0;
}
...
int transpose_coo_3201_k1(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	cout << " , (3, []) ";
	cout << " , "<< res_3 ;
	taco::util::Timer timer_1_cmp_201;
	timer_1_cmp_201.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	for(int i = 1; i < c_size; i ++)
	{
	...
	timer_1_cmp_201.stop();
	taco::util::TimeResults res_1_cmp_201 = timer_1_cmp_201.getResult();
	cout << " | 1_cmp_201 ";
	cout << " | "<< res_1_cmp_201 ;
	// Free the scratch space.
	free(C_coords_scratch);
...
int transpose_coo_3210_k0(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	taco::util::Timer timer_0_cmp_3210;
	timer_0_cmp_3210.start();
	// Use qsort to sort the subtrees
	qsort(C_coords, c_size, sizeof(struct coo_t), cmp_3210);
	timer_0_cmp_3210.stop();
	taco::util::TimeResults res_0_cmp_3210 = timer_0_cmp_3210.getResult();
	cout << " | 0_cmp_3210 ";
	cout << " | "<< res_0_cmp_3210 ;
	return 0;
}
...
int transpose_coo_3210_k1(struct coo_t *C_coords, int c_size, int order, int *dimensions) {
	...
	cout << " , (3, []) ";
	cout << " , "<< res_3 ;
	taco::util::Timer timer_1_cmp_210;
	timer_1_cmp_210.start();
	// Use qsort to sort the subtrees
	int qsort_start = 0;
	for(int i = 1; i < c_size; i ++)
	{
	...
	timer_1_cmp_210.stop();
	taco::util::TimeResults res_1_cmp_210 = timer_1_cmp_210.getResult();
	cout << " | 1_cmp_210 ";
	cout << " | "<< res_1_cmp_210 ;
	// Free the scratch space.
	free(C_coords_scratch);
